...
#define BAR2_LCORE_START (1 << 4) // logic core
#define BAR2_LCORE_STOP (1 << 5)
#define BAR2_LCORE_DONE (1 << 5)
...
typedef struct __attribute__((packed, aligned(32))) {
    ...
    volatile uint32_t addr_lcore_rd; //* 0x030 - Logic Core Read  Address (RW)
    volatile uint32_t addr_lcore_wr; //* 0x034 - Logic Core Write Address (RW)
    volatile uint32_t leng_lcore;    //* 0x038 - Logic Core Length (RW)
